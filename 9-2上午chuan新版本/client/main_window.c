...
void on_button_clicked_chat(GtkWidget* button,gpointer gdata)
{
    Kind kind=enum_chat;
    Data data;
    Packet packet;
...
void update_new(char *friend)//新建联系人
{
    ...
    GtkWidget *label4_0=gtk_label_new(friend);
    PangoFontDescription *font_desc=pango_font_description_from_string("Serif 15");//设置字体
    ...
    GtkButton *button0=gtk_button_new();
    g_signal_connect(G_OBJECT(button0),"clicked",G_CALLBACK(on_button_clicked_chat),NULL);
